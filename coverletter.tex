...
\textbf{Data Engineering:} SQL, PostgreSQL, MongoDB, Apache Spark, R, Data Visualization\par
\textbf{AI Engineering:} RAG, Claude API, FastAPI, Prompt Engineering, n8n automation
\end{sffamily}
\end{flushleft}
