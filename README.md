...
## 🎯 This Branch: Frontend / Full-Stack

React · TypeScript · Next.js · Material UI · Redux · Node.js · MongoDB

## 📄 Live PDFs

| Document | View in Browser |
|----------|----------------|
| 📄 Resume | <a href="https://github.com/YuanshuoDu/resume/blob/frontend/resume.pdf" target="_blank" rel="noopener">Open PDF</a> |
| 📩 Cover Letter | <a href="https://github.com/YuanshuoDu/resume/blob/frontend/coverletter.pdf" target="_blank" rel="noopener">Open PDF</a> |
