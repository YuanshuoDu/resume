...
> 💡 All links open **GitHub's built-in PDF preview** in a new tab — no download required.

## ⚙️ Auto-Build

Every push to any branch triggers CI:
1. Compiles LaTeX → PDF via GitHub Actions
2. Each branch's PDF is always up-to-date with the latest commit

## 🌿 Branch Structure

| Branch | Purpose |
|--------|---------|
| **main** | Clean base — all-direction master resume |
