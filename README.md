...
Azure · Kubernetes · Docker · CI/CD · Terraform · GitHub Actions

## 📄 Live PDFs

| Document | View in Browser |
|----------|----------------|
| 📄 Resume | <a href="https://github.com/YuanshuoDu/resume/blob/devops/resume.pdf" target="_blank" rel="noopener">Open PDF</a> |
| 📩 Cover Letter | <a href="https://github.com/YuanshuoDu/resume/blob/devops/coverletter.pdf" target="_blank" rel="noopener">Open PDF</a> |
