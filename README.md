...
## 🎯 This Branch: SECURITY

DevSecOps · SAST/DAST · KnowBe4 · ISO 27001 · GDPR

## 📄 Live PDFs

| Document | View in Browser |
|----------|----------------|
| 📄 Resume | <a href="https://github.com/YuanshuoDu/resume/blob/security/resume.pdf" target="_blank" rel="noopener">Open PDF</a> |
| 📩 Cover Letter | <a href="https://github.com/YuanshuoDu/resume/blob/security/coverletter.pdf" target="_blank" rel="noopener">Open PDF</a> |
